...
class KnowledgeStore:
    def __init__(self) -> None:
        ...
        self._entry_by_key: dict[tuple[str, str, str], str] = {}
    ...
    def upsert(
        ...
        *,
        ...
        key = (normalized_scope, normalized_kind, normalized_content)
        ...
        if existing_id is not None:
            ...
            if applicability:
                entry.applicability.update(_normalize_applicability(applicability))
        ...
        entry = KnowledgeEntry(
            ...
            applicability=_normalize_applicability(applicability or {}),
        )
...
def _entry_matches_category(entry: KnowledgeEntry, category: str) -> bool:
    ...
    if not expected_category or expected_category == "*":
        return True
    return bool(category) and expected_category == category


def _make_entry_id(key: tuple[str, str, str]) -> str:
